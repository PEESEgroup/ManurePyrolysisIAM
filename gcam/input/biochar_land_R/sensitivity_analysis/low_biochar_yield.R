...
tmp[18] <- "biochar,slow pyrolysis,beef_biochar,beef manure,2.666,2.666,2.666" #[2]
tmp[19] <- "biochar,slow pyrolysis,dairy_biochar,dairy manure,2.901,2.901,2.901" #[2]
