...
tmp[17] <- "biochar,slow pyrolysis,pork_biochar,pork manure,1.828,1.828,1.828" # [4]
tmp[18] <- "biochar,slow pyrolysis,beef_biochar,beef manure,1.742,1.742,1.742" #[2]
tmp[19] <- "biochar,slow pyrolysis,dairy_biochar,dairy manure,1.882,1.882,1.882" #[2]
