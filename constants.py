class GCAMConstants:
    ...
    version =  [["HighCarbonPersistence", "baseline"],
               ["LowCarbonPersistence", "baseline"]]
        # [["Baseline", "baseline"],
        ...
        #        ["HighCarbonPersistence", "baseline"],
        #        ["LowCarbonPersistence", "baseline"],
        #        ["LowBiocharSubsidy", "baseline"]] # error

    GCAMDB_filenames = ["data/gcam_out/HighCarbonPersistence/baseline/ref.csv",
                        "data/gcam_out/LowCarbonPersistence/baseline/ref.csv"]
    # ["data/gcam_out/Baseline/baseline/ref.csv",
